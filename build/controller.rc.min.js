...
m.style.position="absolute";m.style.top=c+"px";m.style.left=e+"px";m.style.width=h+"px";m.style.height=r+"px";m.className="rc-trackpad";var n=function(a,b){relX=a-e;relY=b-c;return{x:relX*k/h,y:relY*p/r}},q=!1,s=function(c){q=!0;c=b?c.changedTouches[0]:c;c=n(c.pageX,c.pageY);g.send(g.events.TRACKPAD_PRESS,{name:a,x:c.x,y:c.y})},u=function(c){q&&(c=b?c.changedTouches[0]:c,c=n(c.pageX,c.pageY),g.send(g.events.TRACKPAD_MOVE,{name:a,x:c.x,y:c.y}))},t=function(c){q=!1;c=b?c.changedTouches[0]:c;c=n(c.pageX,
c.pageY);g.send(g.events.TRACKPAD_RELEASE,{name:a,x:c.x,y:c.y})};b?(f(m,"touchstart",s),f(m,"touchmove",u),f(m,"touchend",t)):(f(m,"mousedown",s),f(m,"mousemove",u),f(m,"mouseup",t));return m}}})(window,document);